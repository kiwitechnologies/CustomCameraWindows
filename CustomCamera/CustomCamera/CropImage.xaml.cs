...
namespace CustomCamera
{
    ...
    /// </summary>
    public sealed partial class CropImage : Page
    {
        private const string CanvasName = "PART_Canvas";
        private const string ImageName = "imgSource";
        ...
        public CropImage()
        {
            ...
            this.DefaultStyleKey = typeof(CropImage);
